...
/***/ function(module, exports, __webpack_require__) {
	...
	var Router = __webpack_require__(1); // or var Router = ReactRouter; in browsers
	    ...
	    render : function(){
	        return (
	            React.createElement("div", {id: "main"}, 
	                React.createElement("ul", {clasName: "header"}, 
	                    React.createElement("li", null, React.createElement(Link, {to: "app"}, "Home")), 
	                    React.createElement("li", null, React.createElement(Link, {to: "list"}, "List")), 
	                    React.createElement("li", null, React.createElement(Link, {to: "concat"}, "Concat"))
	                ), 
	...
	var List = React.createClass({displayName: "List",
	    render : function(){
	        return (
	            React.createElement("div", null, "List Page")    
	        );
	    }
	});

	var Concat = React.createClass({displayName: "Concat",
	    render : function(){
	        return (
	            React.createElement("div", null, "Concat Page")    
	        );
	    }
	});
	...
	var routes = (
	  React.createElement(Route, {name: "app", path: "/", handler: App}, 
	    ...
	    React.createElement(Route, {name: "concat", handler: Concat}), 
